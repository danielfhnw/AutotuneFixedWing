...
plt.grid(True)
plt.title("Drehgeschwindigkeit roh")
plt.xlabel("Zeit [ms]")
...
plt.grid(True)
plt.title("Servo Stellsignal roh")
plt.ylabel("PWM Dutycycle [us]")
plt.xlabel("Zeit [us]")
...
plt.plot(time2,servo,'.')
plt.grid(True)
plt.title("Skalierte Daten")
plt.xlabel("Zeit [ms]")
plt.ylabel("Drehgeschwindigkeit [rad/s] / PWM Dutycycle")
plt.legend(["Drehgeschwindigkeit", "Stellsignal"])
plt.xlim([lower_t, upper_t])
plt.ylim([-3, 2])
plt.show()
...
plt.grid(True)
plt.title("Vergleich Modell")
plt.ylabel("Drehgeschwindigkeit [rad/s]")
plt.legend(["Messdaten", "Vorhersagedaten"])
plt.xlabel("Zeit [ms]")
plt.ylim([-3, 2])
plt.show()
